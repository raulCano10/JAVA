...
public class Cadenas {
    ...
    public static void main(String[] args) {
        ...
        //Solicitar 2 cadenas por teclado
        Scanner sc1 = new Scanner(System.in);
        
        System.out.println("Introduce la primera cadena:");
        String cadenaPrimera = sc1.nextLine();
        
        System.out.println("Introduce la segunda cadena:");
        String cadenaSegunda = sc1.nextLine();
        
        //EQUALS
        
        //compara cadenas
        if(cadenaPrimera.equals(cadenaSegunda)){
            System.out.println("Las cadenas son iguales");
        }else{
            System.out.println("Las cadenas NO son iguales");
        }
        
        //Compara cadenas ignorando Mayusculas y misnusculas
        if(cadenaPrimera.equalsIgnoreCase(cadenaSegunda)){
            System.out.println("Las cadenas son iguales");
        }else{
            System.out.println("Las cadenas NO son iguales");
        }
        
        //comparar cadenas usando CompareTo()
        int resultado = cadenaPrimera.compareTo(cadenaSegunda);
        
        if(resultado == 0){
            System.out.println("Las cadenas son iguales");
        }else if(resultado > 0){
            System.out.println("La primera cadena es MAYOR ALFABETICAMENTE que la segunda cadena");
        }else if(resultado < 0){
            System.out.println("La primera cadena es MENOR ALFABETICAMENTE que la segunda cadena");
        }
